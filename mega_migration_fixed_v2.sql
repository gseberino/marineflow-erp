...
-- SKIP DUPLICATED TABLE: supplier_product_mappings (will be created in a later migration)
...
-- SKIP DUPLICATED TABLE: product_price_history (will be created in a later migration)

-- SKIP DUPLICATED TABLE: price_update_suggestions (will be created in a later migration)
...
-- ==========================================
-- RESTAURAÇÃO DE DADOS VITAIS (AUTOMÁTICA)
-- ==========================================
