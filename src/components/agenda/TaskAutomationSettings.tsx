...
const RULE_DEFS: { id: string; label: string; description: string; defaultEnabled: boolean; clientFacing?: boolean }[] = [
  ...
  { id: 'r17', label: 'Cotação sem resposta do fornecedor', description: 'Tarefa "Cobrar resposta" quando uma cotação passa de 3 dias úteis sem nenhum preço registrado (a janela normal de resposta é de 3 a 5 dias úteis). Some sozinha quando alguém responde ou a cotação é fechada. Nada é enviado ao fornecedor sem você mandar.', defaultEnabled: true },
