...
import { ArrowLeft, Plus, Trash2, AlertTriangle, Calculator, Receipt, Lock, RotateCcw, Ban, FileText, Printer, ChevronDown, MessageCircle, Package, Copy, Camera, MapPin, Clock, Download, Loader2, DollarSign, Percent, Hash, PackagePlus } from 'lucide-react';
