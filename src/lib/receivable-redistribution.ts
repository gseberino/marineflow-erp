...
//
// ⚠ Existe um espelho em `supabase/functions/_shared/receivables/redistribution.ts` (Vite e
// Deno não compartilham módulo aqui) e um teste de paridade que falha se divergirem.
