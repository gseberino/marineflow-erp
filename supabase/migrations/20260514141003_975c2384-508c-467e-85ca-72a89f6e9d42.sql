...
-- Rename snapshot columns to match code expectations
...
-- Update function that referenced old column names
...
BEGIN
  ...
  INSERT INTO public.service_order_services (
    service_order_id, service_id, name_snapshot, description_snapshot,
    billing_unit_snapshot, quantity, unit_price_snapshot, line_total, warranty_days, notes
  )
  SELECT v_so_id, service_id, name_snapshot, description_snapshot,
         billing_unit_snapshot, quantity, unit_price_snapshot, line_total, warranty_days, notes
