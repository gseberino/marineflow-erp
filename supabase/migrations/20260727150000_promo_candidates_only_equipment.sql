-- Curadoria do vendedor autônomo passa a considerar SÓ equipamento (is_equipment=true).
-- Insumo e "a revisar" (null) nunca viram status até serem promovidos a equipamento.
